<template>
  <header class="navbar">
    ...
    <div v-if="jacConfig.logo" ref="jacLogo" class="navbar-logo">
      <component :is="jacConfig.logo" @hook:mounted="handleLinksWrapWidth()" />
    </div>
    ...
    >
      <div
        v-if="jacConfig.extraOptions && jacConfig.extraOptions.before"
        class="user-options-before"
      >
        <component
          :is="jacConfig.extraOptions.before"
          @hook:mounted="handleLinksWrapWidth()"
        />
      </div>
      <user-settings />
      <div
        v-if="jacConfig.extraOptions && jacConfig.extraOptions.after"
        class="user-options-after"
      >
        <component
          :is="jacConfig.extraOptions.after"
          @hook:mounted="handleLinksWrapWidth()"
        />
      </div>
  ...
  methods: {
    handleLinksWrapWidth() {
      ...
      if (document.documentElement.clientWidth < MOBILE_DESKTOP_BREAKPOINT) {
        ...
        const ref = this.$refs[this.jacConfig.logo ? "jacLogo" : "siteName"];
